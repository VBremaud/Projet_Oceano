"""
Calcule la moyenne climatologique pour chaque mois des variables 2D d'océano lu sur un serveur à distance lors de l'execution du code. Renvoi un fichier netcdf contenant les moyennes climatiques pour chaque mois de l'année.
